...
class MigrationTest {
    ...
    void testUsersTableStructure() {
        ...
        boolean hasPasswordHash = columns.stream().anyMatch(col -> "password_hash".equals(col.get("column_name")));
        boolean hasCreatedAt = columns.stream().anyMatch(col -> "created_at".equals(col.get("column_name")));
    ...
    void testRoomsTableStructure() {
        ...
        boolean hasOwnerId = columns.stream().anyMatch(col -> "owner_id".equals(col.get("column_name")));
        boolean hasCreatedAt = columns.stream().anyMatch(col -> "created_at".equals(col.get("column_name")));
    ...
    void testIndexesExist() {
        ...
        List<String> indexNames = indexes.stream()
            .map(index -> (String) index.get("indexname"))
            .toList();
    ...
    void testForeignKeysExist() {
        ...
        boolean hasRoomOwnerFk = foreignKeys.stream().anyMatch(fk -> 
            "rooms".equals(fk.get("table_name")) && "owner_id".equals(fk.get("column_name"))
        );
        boolean hasRoomMemberFk = foreignKeys.stream().anyMatch(fk -> 
            "room_members".equals(fk.get("table_name")) && "room_id".equals(fk.get("column_name"))
        );
