...
public class MetricsService {
    ...
    public MetricsService(MeterRegistry meterRegistry) {
        ...
        // Initialize counters
        this.roomsCreatedCounter = Counter.builder("codeshare.rooms.created")
                .description("Total number of rooms created")
                .register(meterRegistry);
                
        this.roomsJoinedCounter = Counter.builder("codeshare.rooms.joined")
                .description("Total number of room joins")
                .register(meterRegistry);
                
        this.snapshotsWrittenCounter = Counter.builder("codeshare.snapshots.written")
                .description("Total number of snapshots written")
                .register(meterRegistry);
                
        this.websocketConnectionsCounter = Counter.builder("codeshare.websocket.connections")
                .description("Total number of WebSocket connections")
                .register(meterRegistry);
                
        this.websocketDisconnectionsCounter = Counter.builder("codeshare.websocket.disconnections")
                .description("Total number of WebSocket disconnections")
                .register(meterRegistry);
        
        // Initialize timers
        this.snapshotWriteTimer = Timer.builder("codeshare.snapshots.write.duration")
                .description("Time taken to write snapshots")
                .register(meterRegistry);
                
        this.websocketConnectionTimer = Timer.builder("codeshare.websocket.connection.duration")
                .description("Time taken for WebSocket connections")
                .register(meterRegistry);
        
        // Register gauges
        Gauge.builder("codeshare.rooms.active")
                .description("Number of currently active rooms")
                .register(meterRegistry, this, MetricsService::getActiveRooms);
                
        Gauge.builder("codeshare.websocket.connections.active")
                .description("Number of currently active WebSocket connections")
                .register(meterRegistry, this, MetricsService::getActiveWebSocketConnections);
                
        Gauge.builder("codeshare.snapshots.total")
                .description("Total number of snapshots written")
                .register(meterRegistry, this, MetricsService::getTotalSnapshotsWritten);
    }
