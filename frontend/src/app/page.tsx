    ...
    <div className="min-h-screen bg-gradient-to-br from-slate-900 via-red-900 to-slate-900">
      ...
      >
        <div className="max-w-7xl mx-auto flex justify-between items-center">
          ...
          >
            <div className="w-8 h-8 bg-gradient-to-r from-red-500 to-black rounded-lg flex items-center justify-center">
          ...
          >
            ...
            <Link
              href="/register"
              className="bg-gradient-to-r from-red-500 to-black text-white px-6 py-2 rounded-full hover:shadow-lg hover:shadow-red-500/25 transition-all duration-300 transform hover:scale-105"
            >
              Get Started
            </Link>
          </motion.div>
      ...
      <main role="main">
          ...
          <div className="max-w-7xl mx-auto text-center">
            ...
            >
              ...
              <div className="flex flex-col sm:flex-row gap-4 justify-center items-center mb-12">
                <Link
                  href="/register"
                  className="bg-gradient-to-r from-red-500 to-black text-white px-8 py-4 rounded-full text-lg font-semibold hover:shadow-2xl hover:shadow-red-500/25 transition-all duration-300 transform hover:scale-105"
                >
                  Start Coding Now
                </Link>
                <Link
        ...
        {/* Features Section */}
        <section
          className="px-6 py-20 bg-black/20"
          ...
          <div className="max-w-4xl mx-auto text-center">
            ...
            >
              ...
              <p className="text-xl text-gray-300 mb-8 max-w-2xl mx-auto">
                Join thousands of developers, students, and teams who are
                already building the future of collaborative coding.
              </p>
              <Link
                href="/register"
                className="inline-flex items-center bg-gradient-to-r from-red-500 to-black text-white px-10 py-4 rounded-full text-lg font-semibold hover:shadow-2xl hover:shadow-red-500/25 transition-all duration-300 transform hover:scale-105"
              >
      ...
      >
        <div className="max-w-7xl mx-auto text-center">
          <div className="flex items-center justify-center space-x-2 mb-4">
            <div className="w-6 h-6 bg-gradient-to-r from-red-500 to-black rounded flex items-center justify-center">
